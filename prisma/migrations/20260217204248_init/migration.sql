...
CREATE TABLE "MasterDocument" (
    ...
    CONSTRAINT "MasterDocument_standardId_fkey" FOREIGN KEY ("standardId") REFERENCES "Standard" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
-- CreateIndex
CREATE UNIQUE INDEX "Standard_chapterId_version_key" ON "Standard"("chapterId", "version");
